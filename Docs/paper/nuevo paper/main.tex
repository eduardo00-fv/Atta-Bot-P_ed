...
\begin{IEEEkeywords}
swarm robotics, aggregation, environment topology, obstacle avoidance, physical experimentation, robot simulation
\end{IEEEkeywords}
...
% PENDIENTE (01/08): precisar como se acumula la distancia. Sumar las muestras
% crudas la vuelve un proxy de la DURACION -- medido, correlaciona rho=+0.90 con
% el largo del log y da 9-11 veces la recta -- porque el ruido de localizacion
% domina. Los numeros de simulacion se calculan sobre medianas de 1s. Falta
% cotejar con el calculo del laboratorio antes de fijar la redaccion.
